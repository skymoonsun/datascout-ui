            ...
            <div class="row">
                <div class="col-md-3">
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                     src="<?=$paths['cdnUrl']?>/img/mail.png"
                                     alt="User profile picture">
                            </div>

                            <h3 class="profile-username text-center"><?=$loggedUser['name']?></h3>

                            <p class="text-muted text-center"><?=$loggedUser['email']?></p>
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Hedeflerim</b> <a class="float-right" href="hedefler.php"><?=$targetCount?></a>
                                </li>
                                <?php
                                ...
                                ?>
                                <li class="list-group-item">
                                    <b>Veri Akışlarım</b> <a class="float-right" href="veri-akislarim.php"><?=$dataFeedCount?></a>
                                </li>
                            </ul>
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <strong><i class="fas fa-calendar-check mr-1"></i> Kayıt Tarihi</strong>

                            <p class="text-muted">
                                <?=date('d.m.Y H:i:s', $loggedUser['created_at'])?>
                            </p>
